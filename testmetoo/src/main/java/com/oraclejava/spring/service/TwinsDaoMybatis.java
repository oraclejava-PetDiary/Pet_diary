...
public class TwinsDaoMybatis implements TwinsDao{
	...
	public int getTwinsCnt() {
		return session.selectOne("com.oraclejava.spring.service.TwinsDao.getTwinsCnt");
	}
	
	public List<Map<String, Object>> getTwinsList() {
		return session.selectList("com.oraclejava.spring.service.TwinsDao.getTwinsList");
	}

	public Twins getTwinsOne(int id) {
		return session.selectOne("com.oraclejava.spring.service.TwinsDao.getTwinsOne",id);
	}
