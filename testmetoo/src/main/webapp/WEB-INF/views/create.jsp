...
<body>
<form:form action="/springWeb/create" method="post" modelAttribute="twins">
		 
		 <p> 
		    <form:label path="id" cssErrorClass="error-label">선수번호:</form:label>
